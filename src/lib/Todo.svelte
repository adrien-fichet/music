...
<ul>
  ...
  <li>
    ...
    <ul>
      ...
      <li>
        <a href="https://www.tomhull.com/ocston/nm/notes/pjazz-core.php">Penguin Guide to Jazz: Core Collection List</a>
      </li>
    </ul>
  </li>
  ...
  <li>
    Recordings from the
    <a href="https://en.wikipedia.org/wiki/National_Recording_Registry">US National Recording Registry</a>
  ...
  <li>Similar artists research using <a href="https://www.music-map.com/">Music-map</a></li>
  <li>New genres and artists research using <a href="https://everynoise.com/">Every Noise At Once</a></li>
</ul>
